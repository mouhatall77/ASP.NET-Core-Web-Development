    ...
    public class HardCodedSampleDataRepository : IProductDataService
    {
        ...
        public List<ProductModel> GetAllProducts()
        {
            if (productList.Count == 0)
            {
                ...
                productList.Add(new ProductModel { Id = 2, Name = "Web Cam", Price = 45.50m, Description = "Enables you to attend more Zoom meetings." });
                productList.Add(new ProductModel { Id = 3, Name = "4 TB USB hard drive", Price = 130.00m, Description = "Backup all your work. You won't regret it." });
